...
const features = [
  ...
  },
  {
    ...
    0 1 -3.165 2.612c-.917.351-1.887.546-2.897.546s-1.98-.195-2.897-.546a15.96 
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border border-gray-300">
        <div className="p-6 border-b border-gray-300">
          ...
          <p className="text-gray-600 text-md max-w-md">
            Find more than just a house, find your sanctuary. Explore our
            curated listings.
          </p>
        </div>
        ...
        {features.map((item, i) => (
          <div
            key={i}
            className={`text-center p-6 ${i % 3 !== 2 ? "border-l" : ""} ${
              i < 3 ? "border-b" : ""
